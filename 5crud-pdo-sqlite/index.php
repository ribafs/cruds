...
if(isset($_REQUEST['delete_id']))
{
	...
	$select_stmt= $pdo->prepare('SELECT * FROM tbl_person WHERE id =:id');	//sql select query
	$select_stmt->bindParam(':id',$id);
	$select_stmt->execute();
	$row=$select_stmt->fetch(PDO::FETCH_ASSOC);
		
	//delete an orignal record from db
	$delete_stmt = $pdo->prepare('DELETE FROM tbl_person WHERE id =:id');
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
									<?php
									$select_stmt=$pdo->prepare("SELECT * FROM tbl_person");	//sql select query
									$select_stmt->execute();
